- [Instrucciones para el primer examen parcial](#orgb4011fe)
- [Instructions for the midterm exam (in English)](#org634a151)
...
Para la otra parte del examen, leerá el paper de MAGALONI ET AL (que encuentra [aquí](https://github.com/emagar/icp/blob/master/lecturas/anto/ssrn-4007565.pdf)). Elabore una ficha-resumen de una página, igual que las que han estado entregándome. No espero que entienda necesariamente los modelos estadísticos que presentan los autores, pero sí que haga un esfuerzo sincero, leyendo el texto que discute los cuadros estadísticos, por entender la evidencia que cada prueba está aportando.
...
For part 2 of the exam, read the paper by MAGALONI ET AL (found [here](https://github.com/emagar/icp/blob/master/lecturas/anto/ssrn-4007565.pdf)). Prepare a one-page summary of the argument in the same fashion as those you have been turning in. I do not expect you to necessarily understand the statistical models that the authors present, but I do expect that you do a sincere effort, through careful reading of the text discussing statistical tables, to understand what evidence each test is contributing.

Bring for the exam a pen, your cheat-sheet, the MAGALONI ET AL paper, and its corresponding summary.

Please write to emagar@itam.mx if you need clarifications.
